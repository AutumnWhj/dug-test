<template>
  <div class="pt-4 flex flex-col items-center relative">
    <div class="text-center mb-10">
      <div class="text-xl font-extrabold text-primary">立即加入我们</div>
      <div class="text-gray-300/50 text-sm">如有问题需要咨询，可点击左下方按钮联系我们</div>
    </div>
